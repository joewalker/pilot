...
function SelectionType(typeSpec) {
    if (!Array.isArray(typeSpec.data) && typeof typeSpec.data !== 'function') {
        throw new Error('instances of SelectionType need typeSpec.data to be' +
                ' an array or function that returns an array:' +
...
SelectionType.prototype.getLookup = function() {
    ...
    if (Array.isArray(this.data)) {
        this.loopup = _dataToLookup(this.data);
        return this.lookup;
    }
...
BooleanType.prototype.parse = function(arg) {
    if (arg instanceof BooleanNamedArgument) {
